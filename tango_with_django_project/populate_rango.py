...
def add_page(cat, title, url, views=0):
    """Adds a page under a category, or retrieves it if it already exists."""
...
def add_cat(name, views=0, likes=0):
    """Adds a category, or retrieves it if it already exists."""
...
def populate():
    """Populate the database with initial categories and pages."""
